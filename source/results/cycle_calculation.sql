...
begin
    ...
    set new.ratio_r_a = count_by_current(new.r, new.a, new.runtime, charge);
    set new.ratio_r_b = count_by_current(new.r, new.b, new.runtime, charge);
    set new.ratio_g1_a = count_by_current(new.g1, new.a, new.runtime, charge);
    set new.ratio_g1_b = count_by_current(new.g1, new.b, new.runtime, charge);
    set new.ratio_g2_a = count_by_current(new.g2, new.a, new.runtime, charge);
    set new.ratio_g2_b = count_by_current(new.g2, new.b, new.runtime, charge);
